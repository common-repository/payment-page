...
class Stripe extends Skeleton {
    ...
    public static function setup_start_connection( $options ) : array {
        $response = API_PaymentPage::instance()->request( 'stripe/connect', array(
                ...
                'settings'                 => array(
                    'plaid' => array(
                        ...
                        'test_fields'             => array(
                            ...
                            'stripe_test_plaid_secret'    => array(
                        ...
                        'live_fields'             => array(
                            ...
                            'stripe_live_plaid_environment' => array(
                            ...
                            'stripe_live_plaid_secret'      => array(
                                'label' => __( 'Secret', 'payment-page' ),
                                'type'  => 'text',
