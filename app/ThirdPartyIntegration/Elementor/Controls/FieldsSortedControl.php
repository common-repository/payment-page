...
class FieldsSortedControl extends Elementor_Control_Base_Multiple {
	...
	public function enqueue() {
		// Styles
		wp_enqueue_style( 'fieldssorted-control-style', plugins_url( 'interface/elementor/controls/fields-sorted/style.css', PAYMENT_PAGE_BASE_FILE_PATH ), [], PAYMENT_PAGE_VERSION );
		wp_enqueue_style( 'fieldssorted-control-ui-style', '//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css', [], '3.4.1' );
		// Scripts
		wp_register_script( 'fieldssorted-control', plugins_url( 'interface/elementor/controls/fields-sorted/script.js', PAYMENT_PAGE_BASE_FILE_PATH ), [
			'jquery',
			'jquery-ui-sortable',
		], '1.0.0' );
	...
	public function get_default_value() {
		$default_fields = [ 'customText1', 'currency', 'totalPrice', 'customText2', 'frequency' ];
	...
	public function content_template() {
        ...
        <div class="elementor-control-field  field-group-sorted">
            <label for="<?= $control_uid_custom_text_1 ?>"
            ...
            <div
                ...
                <input id="<?= $control_uid_custom_text_1 ?>" type="text"
        ...
        <div class="elementor-control-field  field-group-sorted">
            <label for="<?= $control_uid_custom_text_2 ?>"
                   class="elementor-control-title">Enter custom Text 2:</label>
            <div
                    class="elementor-control-input-wrapper elementor-control-unit-5 elementor-control-dynamic-switcher-wrapper">
                <input id="<?= $control_uid_custom_text_2 ?>" type="text"
                       class="tooltip-target elementor-control-tag-area" data-tooltip=""
                       data-setting="payment_button_text"
        ...
        <div class="elementor-control-field  field-group-sorted">
            <label for="<?= $control_uid_custom_text_3 ?>"
                   class="elementor-control-title">Enter custom Text 3:</label>
            <div
                    class="elementor-control-input-wrapper elementor-control-unit-5 elementor-control-dynamic-switcher-wrapper">
                <input id="<?= $control_uid_custom_text_3 ?>" type="text"
                       class="tooltip-target elementor-control-tag-area" data-tooltip=""
                       data-setting="payment_button_text"
        ...
        <div class="elementor-control-field  fields-sorted field-group-sorted">
            <label for="<?php echo esc_attr( $control_uid_price ); ?>"
                   class="elementor-control-title">{{{ data.label }}}</label>
            <div class="elementor-control-input-wrapper">
                <input type="hidden" id="<?php echo $control_uid_price ?>"
                       data-setting="price">
                <div class="fields-repeater-container">
                    <div class="field-group-sorted">
                        <div id="fields-sorted-container" class="field-input-simulated">
                            ...
                            <div id="frequency" class="ui-state-default">Frequency</div>
                        </div>
                    </div>
                </div>
            </div>
