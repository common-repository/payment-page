...
class GlobalOptions extends Skeleton {
	...
	public function attach_controls() {
		$this->elementorWidgetInstance->start_controls_section(
			$this->control_alias . '_section_title_global_options',
			array(
		...
		$this->elementorWidgetInstance->add_control(
			'section_' . $this->control_alias . '_section_title',
			array(
		...
		payment_page_elementor_builder_attach_margin_control(
			$this->elementorWidgetInstance,
			$this->control_alias,
			'title',
			__( 'Spacing', 'payment-page' ),
			array(
				'unit'        => 'px',
				'size_top'    => 10,
				'size_right'  => 0,
