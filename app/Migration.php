...
class Migration {
	...
	public function setup() {
		...
		register_activation_hook( PAYMENT_PAGE_BASE_FILE_PATH, array( $this, '_plugin_activation_hook' ) );
	...
	public function get_table_structure(): array {
		...
		$response[ $payments ] = 'CREATE TABLE `' . $payments . '` (
                            ...
                            `wp_user_email`   VARCHAR(500) NOT NULL DEFAULT "",
                            ...
                            `paypal_txn_id`   VARCHAR(18) NOT NULL DEFAULT "",
