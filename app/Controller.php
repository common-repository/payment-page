...
class Controller {
    ...
    require_once PAYMENT_PAGE_BASE_PATH . '/app/_functions/administration-payment-form.php';
    ...
    require_once PAYMENT_PAGE_BASE_PATH . '/app/_functions/utilities-css-render.php';
	}
	...
	public function setup() {
		...
		if ( PAYMENT_PAGE_STRIPE_APPLE_PAY_VERIFICATION_TYPE_AUTO === Settings::instance()->get( 'stripe_apple_pay_verification_type_test' )
			...
			add_action( 'init', array( $this, '_maybe_stripe_apple_pay_domain_association' ), - 1000 );
		}
	}
