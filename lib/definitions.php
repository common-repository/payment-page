...
define( "PAYMENT_PAGE_MENU_EMPTY_TOP_LEVEL", 'payment-page-top-level' );

define( "PAYMENT_PAGE_POST_TYPE_PAYMENT_FORM", 'pp_payment_form' );
...
define( "PAYMENT_PAGE_INSTALLED_URL_PATH", 'post-new.php?post_type=' . PAYMENT_PAGE_POST_TYPE_PAYMENT_FORM );